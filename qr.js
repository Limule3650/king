		...
		try {
			...
			Qr_Code_By_Venocyber_Tech.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Venocyber_Tech.sendMessage(Qr_Code_By_Venocyber_Tech.user.id, { text: 'RAPHAEL-MD;;;' + b64data });
	
				   let VENOCYBER_MD_TEXT = `
┌───〈 *_Qr Code By RAPHAEL-MD TECH_* 〉───◆
│╭─────────────···▸
┴│▸
⬡│▸ *_Made With ❤️_*
...
┬│▸ *Credits to raphaelmdtech and venocyber for session id*
│╰────────────···▸▸
└───────────────···▸	
